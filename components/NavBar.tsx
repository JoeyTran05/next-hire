...
const NavBar = () => {
	return (
		<div className="flex z-10 justify-between items-center w-full fixed top-0 h-14 px-12 mx-auto bg-linear-to-r from-white/80 via-white/60 to-white/80 backdrop-blur-xl">
